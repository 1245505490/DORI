...
import warnings
MAX_NUM_STEPS = 1000
warnings.filterwarnings("ignore", message="Euler: Unexpected arguments .*")
...
class ODENet(nn.Module):
    ...
    def __init__(self, device, data_dim, hidden_dim, output_dim=1,
                 ...
                 tol=1e-3, adjoint=False, state=0):
        ...
        self.tol = tol
        self.state = state
        odefunc = ODEFunc(device, data_dim, hidden_dim, augment_dim, time_dependent, non_linearity, state)
...
class ODEFunc(nn.Module):
    ...
    non_linearity : string
        One of 'relu' and 'softplus'
    """
    def __init__(self, device, data_dim, hidden_dim, augment_dim=0, time_dependent=False, non_linearity='relu', state=0):
